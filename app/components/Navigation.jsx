...
const Navigation = () => {
  ...
  <ul className="hidden md:flex items-center lg:gap-8 rounded-full px-12 py-3 gap-6 ">
    <li> <a className="hover:text-gray-600 cursor-pointer yy"  href="#top">Home</a> </li>
    <li><a  className="hover:text-gray-600 cursor-pointer yy" href="#About">About Me</a></li>
    <li><a  className="hover:text-gray-600 cursor-pointer yy" href="#Services">Services</a></li>
    <li><a  className="hover:text-gray-600 cursor-pointer yy" href="#Work">My Work</a></li>
    <li><a  className="hover:text-gray-600 cursor-pointer yy" href="#Contact">Contact Me </a></li>
  </ul>
  ...
  <ul ref={sideMenu} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen transition duration-500 bg-custom-gradient">
